...
/***********************************************************************************
File        : Cybersecurity_Anaysis.do
Authors     : Ariel Dora Stern
Created     : 28 SEP 2017
Modified    : 09 APR 2018
...
use "/Users/astern/Dropbox/MedTech Software/1_Data/medtech_dataset1.dta", clear
tab class
keep if class == "CH" | class == "CV" | class =="DE" | class =="GU" | class =="HO" | class =="OR" | class =="RA" | class =="SU"
keep if yrdec >= 2002
sum yrdec if pma==1
sum yrdec if pma==0
